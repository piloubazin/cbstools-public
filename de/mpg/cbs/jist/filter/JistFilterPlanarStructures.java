 ...
 */
public class JistFilterPlanarStructures extends ProcessingAlgorithm {

	// parameters
	
	// jist containers
	private ParamVolume inputImage;
	private ParamVolume maxdiffImage;
	private ParamVolume mindiffImage;
	private ParamVolume normalImage;
	...
	protected void createInputParameters(ParamCollection inputParams) {
		...
		inputParams.setLabel("Planar Structures");
		inputParams.setName("RidgeStructures");

		AlgorithmInformation info = getAlgorithmInformation();
		info.add(new AlgorithmAuthor("Pierre-Louis Bazin", "bazin@cbs.mpg.de","http://www.cbs.mpg.de/"));
		info.setAffiliation("Max Planck Institute for Human Cognitive and Brain Sciences");
		info.setDescription("Filters an image for oriented 2D structures.");
		
		info.setVersion("3.0.10");
	...
	protected void createOutputParameters(ParamCollection outputParams) {
		outputParams.add(planarImage = new ParamVolume("Planar Structure Image",VoxelType.FLOAT));
		outputParams.setName("planar_image");
		outputParams.setLabel("Planar Image");
	}
