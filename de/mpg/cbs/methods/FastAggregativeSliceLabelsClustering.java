...
public class FastAggregativeSliceLabelsClustering {
	 ...
	 *  constructor
	 */
	public FastAggregativeSliceLabelsClustering(float[] img_, boolean[] msk_,
		...
		nlb = 0;
		for (int z=0;z<nz;z++) {
			int[] list = ObjectLabeling.listLabels(image, nx, ny, 1, nx*ny*z);
